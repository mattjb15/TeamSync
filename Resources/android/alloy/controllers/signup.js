function Controller() {
    ...
    $.__views.signupWin.add($.__views.__alloyId29);
    clickSignup ? $.__views.__alloyId29.addEventListener("click", clickSignup) : __defers["$.__views.__alloyId29!click!clickSignup"] = true;
    ...
    __defers["$.__views.__alloyId29!click!clickSignup"] && $.__views.__alloyId29.addEventListener("click", clickSignup);
    _.extend($, exports);
}
