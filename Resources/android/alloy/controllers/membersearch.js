function Controller() {
    ...
    $.__views.homepageWin.add($.__views.__alloyId23);
    doClick ? $.__views.__alloyId23.addEventListener("click", doClick) : __defers["$.__views.__alloyId23!click!doClick"] = true;
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId23!click!doClick"] && $.__views.__alloyId23.addEventListener("click", doClick);
    _.extend($, exports);
}
