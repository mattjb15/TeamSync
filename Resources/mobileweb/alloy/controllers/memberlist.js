function Controller() {
    ...
    $.__views.membersearchWin.add($.__views.__alloyId26);
    loadMemberSearch ? $.__views.__alloyId26.addEventListener("click", loadMemberSearch) : __defers["$.__views.__alloyId26!click!loadMemberSearch"] = true;
    ...
    __defers["$.__views.__alloyId26!click!loadMemberSearch"] && $.__views.__alloyId26.addEventListener("click", loadMemberSearch);
    _.extend($, exports);
}
