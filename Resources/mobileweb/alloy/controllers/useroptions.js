function Controller() {
    ...
    $.__views.useroptionsWin.add($.__views.__alloyId35);
    updateOptions ? $.__views.__alloyId35.addEventListener("click", updateOptions) : __defers["$.__views.__alloyId35!click!updateOptions"] = true;
    ...
    __defers["$.__views.__alloyId35!click!updateOptions"] && $.__views.__alloyId35.addEventListener("click", updateOptions);
    _.extend($, exports);
}
