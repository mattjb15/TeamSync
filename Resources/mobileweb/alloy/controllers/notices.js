function Controller() {
    ...
    $.__views.noticesWin.add($.__views.__alloyId23);
    loadAddNotice ? $.__views.__alloyId23.addEventListener("click", loadAddNotice) : __defers["$.__views.__alloyId23!click!loadAddNotice"] = true;
    ...
    __defers["$.__views.__alloyId23!click!loadAddNotice"] && $.__views.__alloyId23.addEventListener("click", loadAddNotice);
    _.extend($, exports);
}
