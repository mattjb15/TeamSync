function Controller() {
    ...
    $.__views.memberList = Ti.UI.createLabel({
        text: "Member List",
        id: "memberList",
        top: "10"
    });
    $.__views.index.add($.__views.memberList);
    loadMemberList ? $.__views.memberList.addEventListener("click", loadMemberList) : __defers["$.__views.memberList!click!loadMemberList"] = true;
    $.__views.groupSettings = Ti.UI.createLabel({
        text: "Group Settings",
        id: "groupSettings",
        top: "10"
    });
    $.__views.index.add($.__views.groupSettings);
    ...
    $.__views.memberSearch = Ti.UI.createLabel({
        text: "Member Search",
        id: "memberSearch",
        top: "10"
    });
    $.__views.index.add($.__views.memberSearch);
    loadMemberSearch ? $.__views.memberSearch.addEventListener("click", loadMemberSearch) : __defers["$.__views.memberSearch!click!loadMemberSearch"] = true;
    ...
    __defers["$.__views.memberList!click!loadMemberList"] && $.__views.memberList.addEventListener("click", loadMemberList);
    __defers["$.__views.groupSettings!click!loadGroupSettings"] && $.__views.groupSettings.addEventListener("click", loadGroupSettings);
    __defers["$.__views.memberSearch!click!loadMemberSearch"] && $.__views.memberSearch.addEventListener("click", loadMemberSearch);
    _.extend($, exports);
}
