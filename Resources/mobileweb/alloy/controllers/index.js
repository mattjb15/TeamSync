function Controller() {
    ...
    $.__views.groupHomepage = Ti.UI.createLabel({
        text: "Group Homepage",
        id: "groupHomepage",
        top: "10"
    });
    $.__views.index.add($.__views.groupHomepage);
    loadgroupHomepage ? $.__views.groupHomepage.addEventListener("click", loadgroupHomepage) : __defers["$.__views.groupHomepage!click!loadgroupHomepage"] = true;
    ...
    __defers["$.__views.groupHomepage!click!loadgroupHomepage"] && $.__views.groupHomepage.addEventListener("click", loadgroupHomepage);
    _.extend($, exports);
}
