function Controller() {
    ...
    $.__views.homepageRow.add($.__views.__alloyId21);
    ...
    $.__views.__alloyId21.add($.__views.topRowContainer);
    ...
    $.__views.__alloyId21.add($.__views.middleRowContainer);
    ...
    $.__views.__alloyId21.add($.__views.bottomRowContainer);
    ...
    loadMemberList ? $.__views.events.addEventListener("click", loadMemberList) : __defers["$.__views.events!click!loadMemberList"] = true;
    ...
    __defers["$.__views.events!click!loadMemberList"] && $.__views.events.addEventListener("click", loadMemberList);
