function Controller() {
    ...
    $.__views.signupWin.add($.__views.__alloyId34);
    clickSignup ? $.__views.__alloyId34.addEventListener("click", clickSignup) : __defers["$.__views.__alloyId34!click!clickSignup"] = true;
    ...
    __defers["$.__views.__alloyId34!click!clickSignup"] && $.__views.__alloyId34.addEventListener("click", clickSignup);
    _.extend($, exports);
}
