function Controller() {
    ...
    $.__views.signupWin.add($.__views.__alloyId27);
    clickSignup ? $.__views.__alloyId27.addEventListener("click", clickSignup) : __defers["$.__views.__alloyId27!click!clickSignup"] = true;
    ...
    __defers["$.__views.__alloyId27!click!clickSignup"] && $.__views.__alloyId27.addEventListener("click", clickSignup);
    _.extend($, exports);
}
