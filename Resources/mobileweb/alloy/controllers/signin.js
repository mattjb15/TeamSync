function Controller() {
    ...
    login ? $.__views.__alloyId32.addEventListener("click", login) : __defers["$.__views.__alloyId32!click!login"] = true;
    ...
    $.__views.signinWin.add($.__views.__alloyId33);
    loadSignup ? $.__views.__alloyId33.addEventListener("click", loadSignup) : __defers["$.__views.__alloyId33!click!loadSignup"] = true;
    ...
    __defers["$.__views.__alloyId32!click!login"] && $.__views.__alloyId32.addEventListener("click", login);
    __defers["$.__views.__alloyId33!click!loadSignup"] && $.__views.__alloyId33.addEventListener("click", loadSignup);
    _.extend($, exports);
}
