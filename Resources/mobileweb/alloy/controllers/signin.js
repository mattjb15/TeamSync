function Controller() {
    ...
    $.__views.signinWin.add($.__views.__alloyId25);
    ...
    $.__views.signinWin.add($.__views.__alloyId26);
    loadSignup ? $.__views.__alloyId26.addEventListener("click", loadSignup) : __defers["$.__views.__alloyId26!click!loadSignup"] = true;
    ...
    __defers["$.__views.__alloyId26!click!loadSignup"] && $.__views.__alloyId26.addEventListener("click", loadSignup);
    _.extend($, exports);
}
